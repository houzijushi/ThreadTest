...
**
** Created: Thu Aug 24 10:43:41 2017
...
static const char qt_meta_stringdata_ChildThread[] = {
    "ChildThread\0\0requested()\0slotShowMessage()\0"
};
...
const QMetaObjectExtraData ChildThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ChildThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ChildThread,
      qt_meta_data_ChildThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ChildThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ChildThread))
